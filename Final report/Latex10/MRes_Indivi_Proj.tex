...
is for fastest fabrication and it makes the structure in a layer-by-layer process. The latter is mainly for
 printing arbitrary 3D trajectories~\citep{nanoscribe:2014Aug:Online}. The complete nanoscribe 
...
precise focus trajectory. This type of implementation is know as \ac*{FBMS}~\citep{nanoscribe:2014Aug:Online}.
...
mechanical stability and stick to different substrate very well~\citep{nanoscribe:2014Aug:Online}. A wide
...
with substarte~\citep{nanoscribe:2014Aug:Online}.  
...
The whole printing unit is located in the clean room\footnote{Clean room is an environment with controlled
  concentration of airborne particle to make it suitable for product manufacturing~\citep{cleanroom:2014Sep:Online}. }. 
