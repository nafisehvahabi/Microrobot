...
model which means defining a microrobot with six degree of freedom. The microrobot\rq{}s shape is
...
%  \begin{center}
  ...
  \caption{~\citep{mahoney2011velocity}.}
  \label{RFT-6dof}
%\end{center}
%\end{wrapfigure}
\end{figure}
...
The equation \ref{total_force_torque} summation of two forces and torques which is the total force and torque on microswimmer. 
