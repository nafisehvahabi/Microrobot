...
\tikzstyle{practica} = [materia, text width=16em, minimum width=12em,
...
\newcommand{\background}[5]{%
  \begin{pgfonlayer}{background}
   ...
   \path[fill=pink ,rounded corners, draw=black!50, dashed]
     (4.7,-5.2) rectangle (12.5,1);
...
\begin{tikzpicture}[scale=0.90,[every node/.style={font=\large,
  ...
  \path \Step{1}{Pre processing signals};
  \path (p1.south)+(0.0,-1.5) \Step{2}{Feature extraction};
  \path (p2.south)+(0.0,-1.3) \Step{3}{Translation algorithms};

  \path (p1.east)+(5.0,0.0) \Step{4}{Design by Lego Mindstrom};
  \path (p2.east)+(5.0,0.0) \Step{5}{Calculate forward and inverse kinematic};
  \path (p3.east)+(5.0,0.0) \Step{6}{Design feedback control mechanics};
 ...
 \path [line] (p5.south) -- node [above] {} (p6);
   ...
   \background{p1}{p1}{p3}{p3}{Signal processing }
