...
In the fluidic regime the Reynold number (Re) has a substantial effect on a microdevice
...
Two designs are selected to run the experiment;  the first one is a bare helical structure and the second one is the
 ...
 motion in a fluid environment when there is sufficient \hilight{10m?} magnetic filed. The second 
