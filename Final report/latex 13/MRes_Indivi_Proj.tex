...
a fluid bux with a microhelix inside (c). The sphere domain (b) defins the solution domain
of the system.}\label{Simulation framework}
...
As it has shown in the figure \ref{} 
