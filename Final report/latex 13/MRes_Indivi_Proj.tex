...
Fabrication of microdevice was a considerable challenge for a while ~\citep{qiunanohelices} that has been
overcomed by fabrication methods such as 3D laser lithograph. Section \ref{fabrication} present a
 brief history of fabrication techniques and section \ref{microFabric}
 describes the fabrication method is applied in this study. 
...
%%%%%%%%%%%%%% CHANGED%%%%%%%%%%%%%
\end{tikzpicture}									   %
\caption{Simulation algorithm. The main components of implementing the simulation is shown in 
the diagram.}						   
...
\label{tSimultion model configration}% is used to refer this table in the text
\caption{Simultion model configration. The detail of the Helmholt coils setup
...
\caption{Modeling Simulation Componets. The table shows the componets of each sub-model.}
\end{table}
...
\begin{subfigure}[b]{0.565\textwidth}
        ...
        \caption{Simulation framework. (a) The framework consists of the three inset coils,
...
\begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Simulation domain. (a) The sphere domain is defined for solving the model so the volume of
...
%  \begin{center}
  ...
  \caption{Rotational velocity vs. helix angle }
  \label{RV_pitchAngle}
%\end{center}
%\end{wrapfigure}
\end{figure}
...
%  \begin{center}
  ...
  \caption{Rotational velocity vs. helix pitch }
  \label{RV_helixPitch}
%\end{center}
%\end{wrapfigure}
\end{figure}
...
%  \begin{center}
  ...
  \caption{Rotational velocity vs. helix redius }
...
%  \begin{center}
  ...
  \caption{Rotational velocity vs. helix filament radius }
...
\begin{figure}
       ...
       \begin{subfigure}[b]{0.48\textwidth}
                ...
                \label{CircleBase}
        \end{subfigure}
        \caption{Circle base helix. This is the helix with $12 \mu m$  length and $4\mu m$ pitch. (a) Helix in design
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
       ...
       \begin{subfigure}[b]{0.53\textwidth}
                ...
                \label{largePitch}
        \end{subfigure}
        \caption{The structure (a) is damaged as a result of high 
...
\begin{subfigure}[b]{0.50\textwidth}
       ...
       \begin{subfigure}[b]{0.475\textwidth}
        ...
        \caption{Rectangle based structures. The structures (a) and (b) are examples of
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.42\textwidth}
        ...
        \caption{Pitch variable helix. The image (a) is shown the constant pitch helix which could not printed
